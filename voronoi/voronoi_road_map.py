...
class VoronoiRoadMapPlanner:
    ...
    def __init__(self):
        # tham so
        self.N_KNN = 10  # so canh tu 1 diem lay mau
        self.MAX_EDGE_LEN = 30.0  # [m] chieu dai canh toi da
    ...
    def generate_road_map_info(self, node_x, node_y, rr, obstacle_tree):
        ...
        node_x: [m] x vi tri cua cac diem duoc lay mau
        node_y: [m] y vi tri cua cac diem duoc lay mau
        rr: Robot Radius[m]
